    ...
    <div class="card">
        <div class="card-body">
            <div class="bs-stepper-content">
                <form class="form needs-validation" method="post" enctype="multipart/form-data" action="{{route('brand.store')}}">
                    @csrf
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        <div class="row g-3">
                            <div class="col-12 col-lg-6">
                                <label for="brandName"><strong>Brand Name</strong><i class="text-danger">*</i> </label>
                                <input type="text" id="brandName" class="form-control shadow-lg" value="{{ old('brandName')}}" name="brandName">
